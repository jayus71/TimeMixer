...
DATA_DIR="$PROJECT_ROOT/data/AIIA_hour/split_month_data"
# OUTPUT_BASE="$PROJECT_ROOT/output/AIIA_hour"
# OUTPUT_BASE="$PROJECT_ROOT/output/AIIA_hour/split_half_year_data"
OUTPUT_BASE="$PROJECT_ROOT/output/AIIA_hour/split_month_data"
...
CHECKPOINTS_BASE="$PROJECT_ROOT/checkpoints/AIIA_hour/split_month_data"

# 确保输出和检查点目录存在
mkdir -p $OUTPUT_BASE
mkdir -p $CHECKPOINTS_BASE

# 设置最大并行任务数（根据您的服务器CPU核心数调整）
